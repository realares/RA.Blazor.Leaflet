using RA.Blazor.Leaflet.Models.Events;
...
namespace RA.Blazor.Leaflet.Models
{
	public abstract class InteractiveLayer : Layer
	{
		...
		/// <summary>
		/// If false, the layer will not emit mouse events and will act as a part of the underlying map. (events currently not implemented in RA.Blazor.Leaflet)
		/// </summary>
